...
OtaService::OtaService(SettingsManager& settingsManager, StopCallback stopCallback)
    : settingsManager_(settingsManager), stopCallback_(stopCallback) {}
